  ...
  export default {
    ...
    data() {
      return {
        ...
        categoryTree:[],
        columns: [
          {dataIndex: 'batchNumber', title: '批号', width: 100, align: 'left', ellipsis:true,align: "center"},
          {dataIndex: 'barCode', title: '条码', width: 100, ellipsis:true,align: "center"},
          {dataIndex: 'name', title: '名称', width: 100, ellipsis:true,align: "center"},
          {dataIndex: 'standard', title: '规格', width: 80, ellipsis:true,align: "center"},
          {dataIndex: 'model', title: '型号', width: 80, ellipsis:true,align: "center"},
          {dataIndex: 'commodityUnit', title: '单位', width: 60, ellipsis:true,align: "center"},

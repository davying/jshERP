  ...
  data() {
    return {
      ...
      columns: [
        ...
        { title: "样衣颜色", dataIndex: "sampleColor", width: 80},
      ...
      url: {
        list: "/sampleManagementLog/list",
        delete: "/sampleManagementLog/delete",
        exportXlsUrl: "/sampleManagementLog/exportSampleLogList",
      },
    };
  },

    ...
    data () {
      return {
        ...
        columns: [
          ...
          {title: '名称', dataIndex: 'name', width: 120, ellipsis:true,align: "center"},
          {title: '上级编号', dataIndex: 'parentNumber', width: 80},
          {title: '上级名称', dataIndex: 'parentName', width: 120, ellipsis:true,align: "center"},
          {title: '链接', dataIndex: 'url', width: 250, ellipsis:true,align: "center"},
          {title: '组件', dataIndex: 'component', width: 250, ellipsis:true,align: "center"},

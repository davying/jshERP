      ...
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div>
          <a-table
            ...
            <template slot="customRenderDivide" slot-scope="divideType">
              <a-tag v-if="divideType==1" color="red">55分成</a-tag>
              <a-tag v-if="divideType==2" color="orange">46分成</a-tag>
            </template>
          </a-table>
        </div>
        <!-- table区域-end -->
    ...
    data() {
      return {
        ...
        columns: [
          ...
          { title: '提成类型',dataIndex: 'divideType',width:80,align:"center",
            scopedSlots: { customRender: 'customRenderDivide' }
          },

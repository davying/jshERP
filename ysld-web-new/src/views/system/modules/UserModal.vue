      ...
      <a-spin :spinning="confirmLoading">
        <a-form :form="form" id="userModal">
          ...
          <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="提成类型">
            <a-select placeholder="请选择提成类型" v-decorator="[ 'divideType' ]">
              <a-select-option value="1">55分成</a-select-option>
              <a-select-option value="2">46分成</a-select-option>
            </a-select>
          </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'loginName','username','roleId','orgaId','position','leaderFlag','divideType',

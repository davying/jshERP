  ...
  export default {
    ...
    data () {
      return {
        ...
        defColumns: [
          ...
          {title: '颜色', dataIndex: 'color', width: 70, ellipsis:true,align: "center"},
          {title: '类别', dataIndex: 'categoryName', width: 100, ellipsis:true,align: "center"},
    ...
    methods: {
      ...
      myHandleDelete(record) {
        getAction(this.url.delete,record.id);
        this.loadData();
      },
      getImgUrl(imgName) {

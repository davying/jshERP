    ...
    data () {
      return {
        ...
        columns: [
          ...
          {title: '名称', dataIndex: 'mname', width: 120, ellipsis:true,align: "center"},
          {title: '规格', dataIndex: 'standard', width: 60, ellipsis:true,align: "center"},
          {title: '型号', dataIndex: 'model', width: 60, ellipsis:true,align: "center"},
          {title: '单位', dataIndex: 'mUnit', width: 50, ellipsis:true,align: "center"},
          ...
          {title: '往来单位', dataIndex: 'sname', width: 80, ellipsis:true,align: "center"},
          {title: '仓库', dataIndex: 'dname', width: 80, ellipsis:true,align: "center"},

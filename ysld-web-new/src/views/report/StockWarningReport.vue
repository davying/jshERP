    ...
    data () {
      return {
        ...
        columns: [
          ...
          {title: '仓库', dataIndex: 'depotName', width: 100, ellipsis:true,align: "center"},
          {title: '条码', dataIndex: 'barCode', width: 100},
          {title: '名称', dataIndex: 'mname', width: 100, ellipsis:true,align: "center"},
          {title: '规格', dataIndex: 'mstandard', width: 80, ellipsis:true,align: "center"},
          {title: '型号', dataIndex: 'mmodel', width: 80, ellipsis:true,align: "center"},
          {title: '扩展信息', dataIndex: 'materialOther', width: 100, ellipsis:true,align: "center"},
          {title: '单位', dataIndex: 'materialUnit', width: 60, ellipsis:true,align: "center"},

    ...
    data () {
      return {
        ...
        columns: [
          ...
          {title: '名称', dataIndex: 'name', width: 140, ellipsis:true,align: "center"},
          {title: '规格', dataIndex: 'standard', width: 100, ellipsis:true,align: "center"},
          {title: '型号', dataIndex: 'model', width: 100, ellipsis:true,align: "center"},
          {title: '颜色', dataIndex: 'color', width: 60, ellipsis:true,align: "center"},
          {title: '类别', dataIndex: 'categoryName', width: 60, ellipsis:true,align: "center"},
          {title: '仓位货架', dataIndex: 'position', width: 60, ellipsis:true,align: "center"},
          {title: '单位', dataIndex: 'unitName', width: 60, ellipsis:true,align: "center"},

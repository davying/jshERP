    ...
    data () {
      return {
        ...
        columns: [
          ...
          {title: '名称', dataIndex: 'materialName', width: 160, ellipsis:true,align: "center"},
          {title: '规格', dataIndex: 'materialStandard', width: 80, ellipsis:true,align: "center"},
          {title: '型号', dataIndex: 'materialModel', width: 80, ellipsis:true,align: "center"},
          {title: '扩展信息', dataIndex: 'materialOther', width: 150, ellipsis:true,align: "center"},
          {title: '单位', dataIndex: 'materialUnit', width: 80, ellipsis:true,align: "center"},

  ...
  export default {
    ...
    data () {
      return {
        ...
        // 表头
        columns: [
          { title: '', dataIndex: 'organName',width:120, ellipsis:true,align: "center"},
        ...
        columnsDetail: [
          ...
          { title: '名称', dataIndex: 'name',width:100, ellipsis:true,align: "center"},
          { title: '规格', dataIndex: 'standard',width:100, ellipsis:true,align: "center"},
          { title: '型号', dataIndex: 'model',width:150, ellipsis:true,align: "center"},
          ...
          { title: '备注', dataIndex: 'remark',width:100, ellipsis:true,align: "center"},
        ],
        dataSource:[],
        dataSourceDetail: [],
        url: {

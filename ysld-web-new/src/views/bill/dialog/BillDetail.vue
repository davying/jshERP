    ...
    <a-form :form="form">
      ...
      <template v-else-if="billType === '销售订单'">
        <section ref="print" id="saleOrderPrint">
          <a-row :gutter="24" style="border-top: 0.4px solid grey;">
            <!--            <a-col :span="6">-->
            ...
            <!--              </a-form-item>-->
            <!--            </a-col>-->
            <a-col :span="4" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">&nbsp;订单编号：&nbsp;<span style="font-weight: bolder;color: red;">{{model.number}}</span></div>
<!--              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="订单编号">{{model.number}}</a-form-item>-->
            </a-col>
            <a-col :span="4" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">业务员：&nbsp;{{model.salesMan}}</div>
            </a-col>
            <a-col :span="5" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">客户名称：&nbsp;<span style="font-weight: bolder;color: red;">{{model.customer}}</span></div>
<!--              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="客户名称">-->
<!--                {{model.customer}}-->
<!--              </a-form-item>-->
            </a-col>
            <a-col :span="5" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;font-weight: bolder;color: red;">货源：&nbsp;<a-checkbox style="color: red;">现货</a-checkbox><a-checkbox style="color: red;">定制</a-checkbox></div>
<!--              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="货源">-->
<!--                <a-checkbox> 现货 </a-checkbox>-->
<!--                <a-checkbox> 定制 </a-checkbox>-->
<!--              </a-form-item>-->
            </a-col>
            <a-col :span="6" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">下单日期：&nbsp;{{model.operTimeStr}}</div>
<!--              <a-form-item :labelCol="labelCol"  :wrapperCol="wrapperCol" label="下单日期">-->
<!--                {{model.operTimeStr}}-->
<!--              </a-form-item>-->
            </a-col>
            <a-col :span="6" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;font-weight: bolder;color: red;">&nbsp;交货日期：&nbsp;</div>
              <!--              <a-form-item :labelCol="labelCol"  :wrapperCol="wrapperCol" label="交货日期">-->

              <!--              </a-form-item>-->
            </a-col>
            <a-col :span="6" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">销售单价：<span style="font-weight: bolder;color: red;"></span></div>
...
<!--              </a-form-item>-->
            ...
            <a-col :span="6" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">定金：&nbsp;{{model.financialDeposit}}</div>

<!--              <a-form-item :labelCol="labelCol"  :wrapperCol="wrapperCol" label="定金">-->
<!--                {{model.financialDeposit}}-->
<!--              </a-form-item>-->
            </a-col>
            <a-col :span="6" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">应收尾款：&nbsp;{{model.financialBalance}}</div>
<!--              <a-form-item :labelCol="labelCol"  :wrapperCol="wrapperCol" label="应收尾款">-->
<!--                {{model.financialBalance}}-->
<!--              </a-form-item>-->
            </a-col>
          </a-row>
            <a-row :gutter="24" style="">
              <a-col :span="12" style="border: 0.2px solid grey">
                <div style="height: 30px;line-height: 30px;">&nbsp;款式：&nbsp;<span style="font-weight: bolder;color: red;">{{model.commodityNoStr}}</span></div>
                <!--              <a-form-item :labelCol="labelCol"  :wrapperCol="wrapperCol" label="应收尾款">-->
                <!--                {{model.financialBalance}}-->
                <!--              </a-form-item>-->
              </a-col>
              <a-col :span="12" style="border: 0.2px solid grey">
                <div style="height: 30px;line-height: 30px;">颜色：&nbsp;<span style="font-weight: bolder;color: red;">{{model.color}}</span></div>
                <!--              <a-form-item :labelCol="labelCol"  :wrapperCol="wrapperCol" label="应收尾款">-->
                <!--                {{model.financialBalance}}-->
                <!--              </a-form-item>-->
              </a-col>
          ...
          <a-row :gutter="24" style="">
<!--            <a-col :span="2" style="border: 0.2px solid grey">-->
<!--              <div style="height: 30px;line-height: 30px;">款式</div>-->
<!--            </a-col>-->
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">&nbsp;数量</div>
            </a-col>
<!--            <a-col :span="2" style="border: 0.2px solid grey">-->
<!--              <div style="height: 30px;line-height: 30px;">颜色</div>-->
<!--            </a-col>-->
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">S</div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">M</div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">L</div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">XL</div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="margin-left:0px;height: 30px;line-height: 30px;">2XL</div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">3XL</div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">4XL</div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">5XL</div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">6XL</div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">7XL</div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">XS</div>
            </a-col>
<!--            <a-col :span="5" style="border: 0.2px solid grey">-->
<!--              <div style="height: 30px;line-height: 30px;">备注</div>-->
<!--            </a-col>-->
<!--            <a-col :span="2" style="border-left: 0.2px solid grey;border-right: 0.2px solid grey;border-top: 0.2px solid grey;">-->
<!--              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red;">{{model.commodityNoStr}}</span></div>-->
<!--            </a-col>-->
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red;">&nbsp;{{model.numbers}}</span></div>
            </a-col>
<!--            <a-col :span="1" style="border: 0.2px solid grey">-->
<!--              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red;">{{model.color}}</span></div>-->
<!--            </a-col>-->
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red;white-space:nowrap;">{{model.size1}}</span></div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red;white-space:nowrap;">{{model.size2}}</span></div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red;white-space:nowrap;">{{model.size3}}</span></div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red;white-space:nowrap;">{{model.size4}}</span></div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height:30px;"><span style="font-weight: bolder;color: red;white-space:nowrap;">{{model.size5}}</span></div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red;white-space:nowrap;">{{model.size6}}</span></div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red;white-space:nowrap;">{{model.size7}}</span></div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red;white-space:nowrap;">{{model.size8}}</span></div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red;white-space:nowrap;">{{model.size9}}</span></div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red;white-space:nowrap;">{{model.size10}}</span></div>
            </a-col>
            <a-col :span="2" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red;white-space:nowrap;">{{model.size11}}</span></div>
            </a-col>
<!--            <a-col :span="5" style="border: 0.2px solid grey">-->
<!--              <div style="height: 30px;line-height: 30px;"><span style="font-weight: bolder;color: red">{{model.orderRemark}}</span></div>-->
<!--            </a-col>-->

<!--            <a-col :span="2" style="border-left: 0.2px solid grey;border-right: 0.2px solid grey;">-->
...
<!--            <a-col :span="2" style="border-left: 0.2px solid grey;border-right: 0.2px solid grey;border-bottom: 0.2px solid grey;">-->
<!--              <div style="height: 30px;line-height: 30px;"></div>-->
<!--            </a-col>-->
<!--            <a-col :span="2" style="border: 0.2px solid grey">-->
<!--              <div style="height: 30px;line-height: 30px;"></div>-->
...
<!--            </a-col>-->
            ...
            <a-col :span="6" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">&nbsp;是否开票：&nbsp;{{model.billingRate}}</div>
            </a-col>
            <a-col :span="6" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">收货人姓名：<span style="font-weight: bolder;color: red;"></span></div>
            </a-col>
            <a-col :span="6" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">联系电话：<span style="font-weight: bolder;color: red;"></span></div>
            </a-col>
            <a-col :span="6" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">运费付款方：<span style="font-weight: bolder;color: red;">{{model.freightPayer}}</span></div>
            </a-col>
            <a-col :span="10" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">&nbsp;客户地址：<span style="font-weight: bolder;color: red;"></span></div>
            </a-col>
            <a-col :span="4" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;">实发数量：&nbsp;</div>
            </a-col>
            <a-col :span="10" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;font-weight: bolder;color: red;">特别提醒：&nbsp;
                <a-checkbox style="color: red;"> 等通知放货 </a-checkbox>
                <a-checkbox style="color: red;"> 直接送货上门 </a-checkbox>
                <a-checkbox style="color: red;"> 物流站自提 </a-checkbox></div>
            </a-col>
            <a-col :span="6" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;font-weight: bolder;color: red;">&nbsp;发货日期：&nbsp;</div>
            </a-col>
            <a-col :span="18" style="border: 0.2px solid grey">
              <div style="height: 30px;line-height: 30px;font-weight: bolder;color: red;">备注：<span style="font-weight: bolder;color: red">{{model.orderRemark}}</span></div>
            </a-col>

          </a-row>
<!--          <br>-->
          <div :style="tableWidth" v-show="false">
            <a-table
...
<!--          <br>-->
          <a-row class="form-row" :gutter="24" style="border: 0.2px solid grey">
            <template v-for="(file,index) in saleFileList">
                <a-col :span="5">
                  <br>
<!--                  <a-form-item :labelCol="labelCol" :wrapperCol="{xs: { span: 24 },sm: { span: 24 }}" label="前胸图">-->
                    <img :src="getImgUrl(fileList,index)" style="height:300px;max-width:225px;"/>
<!--                  </a-form-item>-->
                </a-col>
<!--                <a-col :span="6">-->
<!--                  <a-form-item :labelCol="labelCol" :wrapperCol="{xs: { span: 24 },sm: { span: 24 }}" label="后背图">-->
<!--                    <img :src="getImgUrl(fileList,1)" style="height:300px;max-width:225px;"/>-->
<!--                  </a-form-item>-->
<!--                </a-col>-->
            </template>
            <template v-if="fileList && fileList.length>0">
              <a-col :span="4" style="float:right">
                <br>
                <div>前胸：_______________</div>
                <br>
                <div>后背：_______________</div>
                <br>
                <div>袖子：_______________</div>
              </a-col>
            </template>
<!--            <template v-if="fileList && fileList.length>0">-->
<!--              <a-col :lg="6" :span="6">-->
<!--                  <a-form-item :labelCol="labelCol" :wrapperCol="{xs: { span: 24 },sm: { span: 24 }}" label="前胸图">-->
<!--                    <img :src="getImgUrl(fileList,0)" style="height:300px;max-width:225px;"/>-->
<!--                  </a-form-item>-->
<!--                </a-col>-->
<!--              <a-col :span="6">-->
<!--                <a-form-item :labelCol="labelCol" :wrapperCol="{xs: { span: 24 },sm: { span: 24 }}" label="后背图">-->
...
<!--            <a-col :lg="6" :md="12" :sm="24">-->
<!--              <a-form-item :labelCol="labelCol" :wrapperCol="{xs: { span: 24 },sm: { span: 24 }}" label="下单备注：" style="padding:20px 10px;">{{model.orderRemark}}</a-form-item>-->
<!--            </a-col>-->
<!--          </a-row>-->
          <a-row class="form-row" :gutter="24">
            <a-col :lg="6" :span="6">
              <a-form-item :labelCol="{xs: { span: 24 },sm: { span: 10 }}" :wrapperCol="wrapperCol" label="开单人(签名)：">
              </a-form-item>
            </a-col>
            <a-col :span="6">
              <a-form-item :labelCol="{xs: { span: 24 },sm: { span: 10 }}" :wrapperCol="wrapperCol" label="出库人(签名)：">
              </a-form-item>
            </a-col>
            <a-col :span="6">
              <a-form-item :labelCol="{xs: { span: 24 },sm: { span: 10 }}" :wrapperCol="wrapperCol" label="印刷人确认(签名)：">
              </a-form-item>
            </a-col>
            <a-col :span="6"></a-col>
          </a-row>
  ...
  data () {
    return {
      ...
      url: {
        ...
        detailList1: '/depotItem/getDetailList1',
      ...
      saleOrderColumns: [
        { title: '货品编码', dataIndex: 'commodityNoStr', width: 150},
        // { title: '货品编码11', dataIndex: 'commodityNoStr',
        ...
        //     return text
        //   }},
        // { title: '货品名称', dataIndex: 'commodityName'},
        { title: '颜色', dataIndex: 'color'},
        { title: 'S', dataIndex: 'size1'},
        { title: 'M', dataIndex: 'size2'},
        { title: 'L', dataIndex: 'size3'},
        { title: 'XL', dataIndex: 'size4'},
        { title: '2XL', dataIndex: 'size5'},
        { title: '3XL', dataIndex: 'size6'},
        { title: '4XL', dataIndex: 'size7'},
        { title: '5XL', dataIndex: 'size8'},
        { title: '6XL', dataIndex: 'size9'},
        { title: '7XL', dataIndex: 'size10'},
        { title: 'XS', dataIndex: 'size11'},
        { title: '数量', dataIndex: 'numbers'},
        { title: '单价', dataIndex: 'financialUnitPrice'},
        { title: '金额', dataIndex: 'totalFinancialPrice'},
        { title: '下单备注', dataIndex: 'orderRemark'},
        // { title: '条码', dataIndex: 'barCode'},
        // { title: '名称', dataIndex: 'name'},
        // { title: '规格', dataIndex: 'standard'},
        // { title: '型号', dataIndex: 'model'},
  ...
  methods: {
    getImgUrl(fileName,size) {
      if(fileName && fileName.split(',')) {
        return getFileAccessHttpUrl('systemConfig/static/' + fileName.split(',')[size])
      } else {
        return ''
      }
    },
    ...
    show(record, type, prefixNo) {
      //查询单条单据信息
      findBillDetailByNumber({ number: record.number||record.id }).then((res) => {
        if (res && res.code === 200) {
          let item = res.data
          this.billType = type
          ...
          if(item.fileName){
            this.saleFileList=item.fileName.split(',')
          }
          this.visible = true
          this.modalStyle = 'top:20px;height: 95%;'
          this.model = Object.assign({}, item)
          this.model.operTimeStr = moment(item.operTime).format("YYYY-MM-DD HH:mm:ss");
          this.model.salesManStr = item.salesMan;
    ...
    requestSubTableData(record, type, url, params, success) {
      this.loading = true
      if(type=='销售订单'){
        getAction(this.url.detailList1, params).then(res => {
          if(res && res.code === 200){
    ...
    orderExportExcel() {
      ...
      aoa = [['销售人员：', this.model.salesManStr, '', '单据日期：', this.model.operTimeStr, '', '单据编号：', this.model.number],[]]
      let title = ['货品编码', '货品名称', '颜色', 'S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL', '6XL', '7XL', 'XS', '数量']
      aoa.push(title)
      for (let i = 0; i < this.dataSource.length; i++) {
        let ds = this.dataSource[i]
        let item = [ds.commodityNo, ds.commodityName, ds.color, ds.size1, ds.size2, ds.size3, ds.size4, ds.size5, ds.size6,
          ds.size7, ds.size8, ds.size9, ds.size10, ds.size11, ds.numbers]
        aoa.push(item)
      }
      aoa.push([])
      aoa.push(['下单备注：', this.model.orderRemark])
      aoa.push([])
      aoa.push(['开单人(签名)：', '','','', '出库人(签名)：', '','','', '印刷人确认(签名)：', ''])
      openDownloadDialog(sheet2blob(aoa), this.billType + '_' + this.model.number)
    },

...
<!--          <a-dropdown>-->
<!--            <a-menu slot="overlay">-->
<!--              <a-menu-item key="1"  @click="batchDel111"><a-icon type="delete"/>删除</a-menu-item>-->
<!--&lt;!&ndash;              <a-menu-item key="2"  @click="batchSetStatus(1)"><a-icon type="check"/>审核</a-menu-item>&ndash;&gt;-->
<!--&lt;!&ndash;              <a-menu-item key="3" v-if="checkFlag && btnEnableList.indexOf(7)>-1" @click="batchSetStatus(0)"><a-icon type="stop"/>反审核</a-menu-item>&ndash;&gt;-->
<!--            </a-menu>-->
<!--            <a-button>-->
    ...
    data () {
      return {
        ...
        columns: [
          ...
          // {title: '发货单号', dataIndex: 'shippingOrderNumber', width: 80,ellipsis:true}
        ...
        url: {
          ...
          deleteBatch: "/warehouseManagementOld/deleteBatch",
          batchSetStatusUrl: "/warehouseManagementOld/batchSetStatus",
          getOne: "/warehouseManagementOld/info",
        }
      }
    },
    computed: {

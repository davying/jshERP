    ...
    return {
      ...
      materialTable: {
        ...
        columns: [
          ...
          // },
          { title: "颜色", key: "color", width:'8%',type: FormTypes.input,
            validateRules: [{ required: true, message: '${title}不能为空' }]},
          ...
          {title: "到货时间", key: "inTime", width:'10%', type: FormTypes.date,
            validateRules: [{ required: true, message: '${title}不能为空' }]},
          { title: "单价(元)", key: "price", width: '5%', ellipsis: true,type: FormTypes.input
          ,validateRules: [{ required: true, message: '${title}不能为空' }]},
          { title: "入库备注", key: "remark", width: '10%' , ellipsis:true,type: FormTypes.input}

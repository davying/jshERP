  ...
  data () {
    return {
      ...
      materialTable: {
        ...
        dataSource: [],
        columns: [
          { title: '订单编号', key: 'depotIds', width: '10%', kind: 'depotIds',type: FormTypes.select, placeholder: '请选择${title}', options: [],
            allowSearch:true, validateRules: [{ required: true, message: '${title}不能为空' }]
          },
          { title: '货品编码', key: 'commodityNo', width: '10%', type: FormTypes.normal },
          { title: '类型', key: 'type', width: '10%', type: FormTypes.select, placeholder: '请选择${title}', options: [],
            allowSearch:true, validateRules: [{ required: true, message: '${title}不能为空' }]
          },
          // { title: '条码', key: 'barCode', width: '12%', type: FormTypes.popupJsh, kind: 'material', multi: true,
          //   validateRules: [{ required: true, message: '${title}不能为空' }]
          // },
          { title: "颜色", key: "color", width:'8%',type: FormTypes.normal,
            validateRules: [{ required: true, message: '${title}不能为空' }]},
          ...
          { title: "出库备注", key: "remark", width:'8%',type: FormTypes.input},
          // { title: "出库备注", key: "remark", width:'6%',type: FormTypes.input},
      ...
      url: {
        ...
        add: '/warehouseManagement/warehouseManagementOutRows',

        ...
        <a-row class="form-row" :gutter="24">
          ...
          <a-col :md="6" :sm="6">
            <a-form-item
                ...
                data-intro="物流方式必填"
            >
              <a-textarea v-decorator.trim="['logisticsMode']"
              />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="6">
        ...
        <a-row class="form-row" :gutter="24">
          <a-col :md="6" :sm="12">
            <a-form-item
                ...
                data-intro="发货单号必填"
            >
              <a-textarea v-decorator.trim="['shippingOrderNumber']"
              />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="6">
            <a-form-item
                ...
                data-intro="备注非必填"
            >
              <a-textarea v-decorator.trim="['remark']" onmouseover="this.title=this.value"
              />
            </a-form-item>
          </a-col>
        </a-row>
...
export default {
  ...
  methods: {
    handleTypeChange(){
      ...
      getAction(this.url.checkNumberOutInfo, {type:"发货",depotId:depotIdStr}).then((res) => {
        if (res.code == 1) {

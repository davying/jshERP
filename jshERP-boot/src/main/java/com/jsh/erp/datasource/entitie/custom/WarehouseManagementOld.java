...
@Getter
@Setter
@TableName("jsh_warehouse_management_old")
@ApiModel(value = "WarehouseManagementOld对象", description = "入出库记录表")
public class WarehouseManagementOld {
    ...
    @ApiModelProperty("类型(全部出库/部分出库/入库)")
    @TableField("`type`")
    private String type;

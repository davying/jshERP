...
public class VincentCode {

    // ck数据库连接字段配置
//    private static final String JDBC_URL = "jdbc:clickhouse://2.20.207.9:8123";
//    private static final String JDBC_USER_NAME = "default";
//    private static final String JDBC_PASSWORD = "City_ops123.";

    // 本地
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/ods?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSl=true";
    private static final String JDBC_USER_NAME = "root";
    private static final String JDBC_PASSWORD = "password";

    // 测服
//    private static final String JDBC_URL = "jdbc:mysql://61.177.139.223:4470/jsh_erp";
//    private static final String JDBC_USER_NAME = "root";
//    private static final String JDBC_PASSWORD = "0doubt$Elroy$Uncharted";

    // 包名和模块名
    private static final String PACKAGE_NAME = "com.jsh";
    ...
    // 表名,多个表使用英文逗号分割
    private static final String[] TBL_NAMES = {"o_ty_gaj_t_xt_ybss"};

    // 表名的前缀,从表生成代码时会去掉前缀
    private static final String TABLE_PREFIX = "o_ty_";
...
//                        .fileOverride()
        ...
        fastAutoGenerator.packageConfig(
                packageConfigBuilder -> packageConfigBuilder
                        ...
                        .entity("datasource.entitie.".concat(TYPE_NAME))
                        .mapper("datasource.mappers.".concat(TYPE_NAME))
//                        .xml("datasource.mappers.".concat(TYPE_NAME).concat(".xml"))
                        .service("service.".concat(TYPE_NAME))
                        .serviceImpl("service.".concat(TYPE_NAME).concat(".impl"))
//                        .controller("controller.".concat(TYPE_NAME))
        );
        /**
         // 4.模板配置

...
//                if (StrUtil.isNotBlank(obj[h]) && (NumberUtil.isInteger(obj[h]) || NumberUtil.isNumber(obj[h]))) {
//                    log.info("整数：{}", obj[h]);
//                    WritableCellFormat wcf1 = new WritableCellFormat(new NumberFormat("#"));
//                    Number number = new Number(h, rowNum, Integer.parseInt(obj[h]), wcf1);
//                    sheet.addCell(number);
//                } else if (StrUtil.isNotBlank(obj[h]) && NumberUtil.isDouble(obj[h])) {
//                    log.info("浮点数：{}", obj[h]);
//                    WritableCellFormat wcf1 = new WritableCellFormat(new NumberFormat("#.##"));
//                    Number number = new Number(h, rowNum, NumberUtil.round(obj[h], 2).doubleValue(), wcf1);
//                    sheet.addCell(number);
//                } else {
